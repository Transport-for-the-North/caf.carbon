...
class TestCurveFitting:
    def test_generate_scrappage(self, mock_curvefitting_invariant_obj):
        exp_data = {'cya': [0, 0, 1, 1, 2, 3, 2, 3, 4, 4],
                    'vehicle_type': ['car', 'lgv', 'lgv', 'car', 'car', 'car', 'lgv', 'lgv', 'lgv', 'car'],
        ...
        pd.testing.assert_frame_equal(exp_scrappage, actual_scrappage, check_dtype=False, check_like=True)

    def test_characteristics_to_rwc(self, mock_curvefitting_invariant_obj):
        exp_data = {'cohort': [2010, 2010, 2010, 2010],
        ...
        class_curve = CurveFitting()
        actual = class_curve.characteristics_to_rwc(invariant_obj=mock_curvefitting_invariant_obj)
    ...
    def test_calculate_speed_band_emissions(self, mock_curvefitting_invariant_obj):
        exp_data = {'segment': ['medium', 'medium', 'n1 class i', 'n1 class i', 'medium', 'medium', 'n1 class i',
                                'n1 class i', 'medium', 'medium', 'n1 class i', 'n1 class i', 'medium', 'medium',
                                'n1 class i', 'n1 class i', 'medium', 'medium', 'n1 class i', 'n1 class i', 'medium',
                                'medium', 'n1 class i', 'n1 class i'],
                    'fuel': ['bev', 'petrol', 'diesel', 'phev', 'bev', 'petrol', 'diesel', 'phev',
                             'bev', 'petrol', 'diesel', 'phev', 'bev', 'petrol', 'diesel', 'phev',
                             'bev', 'petrol', 'diesel', 'phev', 'bev', 'petrol', 'diesel', 'phev'],
                    'e_cohort': [2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010,
                                 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010, 2010],
                    'vehicle_type': ['car', 'car', 'lgv', 'lgv', 'car', 'car', 'lgv', 'lgv', 'car', 'car', 'lgv', 'lgv',
                                     'car', 'car', 'lgv', 'lgv', 'car', 'car', 'lgv', 'lgv', 'car', 'car', 'lgv', 'lgv'],
                    'speed_band': ['10_30', '10_30', '10_30', '10_30', '30_50', '30_50', '30_50', '30_50', '50_70',
                                   '50_70', '50_70', '50_70', '70_90', '70_90', '70_90', '70_90', '90_110', '90_110',
                                   '90_110', '90_110', '110_130', '110_130', '110_130', '110_130'],
                    'gco2/km': [0, 10e20, 10e20, 11.98, 0, -23526.29, -31364.12, -6.23, 0, -22540.50, -30596.73, -12.66,
                                0, -22178.29, -30333.39, -15.96, 0, -22002.02, -30212.58, 10e20, 0, -21901.47, 10e20,
                                10e20]}
        exp_se_calcs = pd.DataFrame(data=exp_data)

        class_curve = CurveFitting()
        actual_df = class_curve.calculate_speed_band_emissions(invariant_obj=mock_curvefitting_invariant_obj)
