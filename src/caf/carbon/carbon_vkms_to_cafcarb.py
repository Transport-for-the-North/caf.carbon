...
class VKMPreprocessing:
    ...
    def __generate_inputs(self, parameters):
        ...
        def apply_trip_bands(dataframe):
            ...
            dataframe.loc[dataframe["route_distance"] <= self.trip_bands[0], "trip_band"] = f"0-{self.trip_bands[0]}km"
            for boundary in range(0, S):
                dataframe.loc[(dataframe["route_distance"] > self.trip_bands[boundary]) & (
                        dataframe["route_distance"] <= self.trip_bands[
                    boundary + 1]), "trip_band"] = f"{self.trip_bands[boundary]}-{self.trip_bands[boundary + 1]}km"
            dataframe.loc[dataframe["route_distance"] > self.trip_bands[S], "trip_band"] = f"{self.trip_bands[S]}+km"
            return dataframe
        ...
        def rename_speed_bands(data_frame):
            ...
            if 'vkm_30-50_kph' not in data_frame.columns:
                data_frame = data_frame.rename(
                    columns={'0-10': 'vkm_0-10_kph', '10-30': 'vkm_0-30_kph', '110+': "vkm_110+_kph",
                             '30-50': 'vkm_30-50_kph', '50-70': 'vkm_50-70_kph', '70-90': 'vkm_70-90_kph',
                             '90-110': 'vkm_90-110_kph'})
            print(data_frame.columns)
            if 'vkm_0-10_kph' in data_frame.columns:
                data_frame["vkm_0-30_kph"] = data_frame["vkm_0-10_kph"] + data_frame["vkm_0-30_kph"]
            if "vkm_110+_kph" in data_frame.columns:
                data_frame["vkm_90-110_kph"] = data_frame["vkm_90-110_kph"] + data_frame["vkm_110+_kph"]
            return data_frame
        ...
        for time_period in ["TS1", "TS2", "TS3"]:
            ...
            car_chunk = car_chunk[["origin", "destination", "through",
                                        "user_class", "trip_band",
                                        "vkm_0-30_kph",
                                        "vkm_30-50_kph",
                                        "vkm_50-70_kph",
                                        "vkm_70-90_kph",
            ...
            lgv_chunk = lgv_chunk[["origin", "destination", "through",
                                        "user_class", "trip_band",
                                        "vkm_0-30_kph",
                                        "vkm_30-50_kph",
                                        "vkm_50-70_kph",
            ...
            hgv_chunk = hgv_chunk[["origin", "destination", "through",
                                        "user_class", "trip_band",
                                        "vkm_0-30_kph",
                                        "vkm_30-50_kph",
                                        "vkm_50-70_kph",
            ...
            car = car.groupby(["origin", "destination", "through", "trip_band", "user_class"], as_index=False).sum()
